...
const BlogSingle = ({ post, comments }: BlogSingleProps) => {
  ...
  return (
    <section className="blog-area-7" suppressHydrationWarning={true}>
      <div className="container" suppressHydrationWarning={true}>
        <div className="work-area-7-inner section-spacing" suppressHydrationWarning={true}>
          <div className="section-content-wrapper" suppressHydrationWarning={true}>
            <div className="main-content" suppressHydrationWarning={true}>
              <div className="blog-details-wrapper fade-anim" suppressHydrationWarning={true}>
